...
module "frontend_ingress" {
  depends_on        = [module.aks, module.postgresql, module.storage, module.acr, module.tlscert]
...
module "lockdown" {
  ...
  depends_on        = [module.acr, module.ingress, module.frontend_ingress, module.perimeter, data.kubernetes_service.ingress_service, module.tlscert]
}
...
module "oauth" {
  ...
  depends_on        = [module.aks, module.tlscert]
}
...
module "tlscert" {
  ...
  depends_on        = [module.aks, data.kubernetes_service.ingress_service]
}