...
def getRelevantEmbeds(df_Save, engine=None, table_name_tokenize=table_name_tokenize, table_name_embed=table_name_embed, model_name=None):
...
def selectModel(model_name, db, disAmbig=False):
    ...
    embed_df = getRelevantEmbeds(df_Save, db.engine, model_name=model_name)
